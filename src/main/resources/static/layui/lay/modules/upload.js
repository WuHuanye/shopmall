...
;layui.define("layer", function (e) {
    ...
    p.prototype.config = {
        ...
        var n, a = this, l = a.config, r = a.elemFile[0], u = function () {
            ...
            if ("choose" !== i && !l.auto || (l.choose && l.choose(g), "choose" !== i)) return l.before && l.before(g), o.ie ? o.ie > 9 ? u() : c() : void u()       //原来9.11注释
            // return "choose" === t ? l.choose && l.choose(g) : ((l.before && l.before(g)) === false ? '' : a.ie ? a.ie > 9 ? u() : c() : void u())   //改过*9.11新增* https://blog.csdn.net/qq_34252360/article/details/104281555?utm_medium=distribute.pc_aggpage_search_result.none-task-blog-2~all~first_rank_v2~rank_v25-11-104281555.nonecase&utm_term=layui%E5%A4%9A%E5%A4%84%E4%B8%8A%E4%BC%A0%E5%9B%BE%E7%89%87
